...
public Q_SLOTS:
	...
	*******************************************/
    ...
    void on_button_copy_location_clicked(bool chack);
    void on_button_copy_object_clicked(bool chack);
    void on_button_copy_slot_clicked(bool chack);
    void on_button_copy_box_clicked(bool chack);
